    ...
    return (
      <div className="flex h-screen flex-col items-center justify-center gap-3 bg-white px-6 text-center">
        <p className="max-w-md text-sm text-neutral-600">
          This link is for <strong>lecture</strong> modules only. This item is a{" "}
          <strong>{module.kind.replace("_", " ")}</strong>.
        </p>
        <Link
          href="/weekly-plan"
    ...
    return (
      <div className="flex h-screen flex-col items-center justify-center gap-3 bg-white px-6 text-center">
        <p className="max-w-md text-sm text-neutral-600">
          ...
          <Link href="/weekly-plan" className="font-medium text-neutral-900 underline">
            Weekly Plan
          </Link>{" "}
