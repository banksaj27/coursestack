...
export default function ChatPanel() {
  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between gap-3 border-b border-neutral-100 bg-white px-8 py-3 dark:border-neutral-800 dark:bg-neutral-900">
